  ...
  <div class="trade-container">
    ...
    <div class="trade">
      ...
      <div class="receiveInfo">
        寄送至:
        <span>{{ userDefaultress.fullAddress }}</span>
        收货人：<span>{{ userDefaultress.consignee }}</span>
        <span>{{ userDefaultress.phoneNum }}</span>
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    async submitOrder() {
      ...
      // 其余参数
      let data = {
        consignee: this.userDefaultress.consignee, // 收件人用户名
        consigneeTel: this.userDefaultress.phoneNum, // 收件人手机号
        deliveryAddress: this.userDefaultress.fullAddress, // 收件人地址
